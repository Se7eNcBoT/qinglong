...
update_qinglong() {
    ...
    reset_romote_url ${dir_root} "${github_proxy_url}https://github.com/Se7eNcBoT/qinglong.git"
    ...
    local url="${github_proxy_url}https://github.com/Se7eNcBoT/qinglong-static.git"
